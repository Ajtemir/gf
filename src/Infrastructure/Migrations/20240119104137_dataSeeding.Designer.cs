...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240119104137_dataSeeding")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "a9fd8470-98b2-426c-925e-6d225b114c71",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "320f2064-5e0a-4659-8af0-eb2934123cf1",
                            CreatedAt = new DateTime(2024, 1, 19, 10, 41, 36, 782, DateTimeKind.Utc).AddTicks(4546),
                            Email = "Admin@test.ru",
                            ...
                            ModifiedAt = new DateTime(2024, 1, 19, 10, 41, 36, 782, DateTimeKind.Utc).AddTicks(4577),
                            PasswordHash = "AQAAAAIAAYagAAAAEIpwrFAM+yCqiFvw9wuooZ8gvUgqWG/IaNY/q3qtE0YUx7q6sflJyL6FwrMaTe07Dw==",
            ...
            modelBuilder.Entity("Domain.Entities.DocumentType", b =>
                {
                    ...
                    b.ToTable("DocumentTypes", "main");
                });

            modelBuilder.Entity("Domain.Entities.IssuedReward", b =>
                {
                    b.Property<int>("RewardApplicationStatusId")
                        .HasColumnType("integer");

                    b.HasKey("RewardApplicationStatusId");

                    b.ToTable("IssuedRewards", "main");
                });
            ...
            modelBuilder.Entity("Domain.Entities.MothersChildren", b =>
                {
                    ...
                    b.HasKey("MotherId", "ChildId");

                    b.HasIndex("ChildId");

                    b.ToTable("MothersChildren", "main");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Office", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 51617,
                            CreatedAt = new DateTime(2024, 1, 19, 10, 41, 36, 839, DateTimeKind.Utc).AddTicks(4820),
                            CreatedBy = 1,
                            ModifiedAt = new DateTime(2024, 1, 19, 10, 41, 36, 839, DateTimeKind.Utc).AddTicks(4844),
                            ModifiedBy = 1,
            ...
            modelBuilder.Entity("Domain.Entities.PinAbsenceReason", b =>
                {
                    ...
                    b.ToTable("PinAbsenceReasons", "main");
                });
            ...
            modelBuilder.Entity("Domain.Entities.IssuedReward", b =>
                {
                    b.HasOne("Domain.Entities.RewardApplicationStatus", "RewardApplicationStatus")
                        .WithMany()
                        .HasForeignKey("RewardApplicationStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RewardApplicationStatus");
                });
            ...
            modelBuilder.Entity("Domain.Entities.MothersChildren", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Mother", "Mother")
                        .WithMany()
